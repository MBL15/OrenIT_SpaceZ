...
# Уровень 1 с 0 ОП; каждые следующие 1000 ОП — новый уровень (2-й с 1000 ОП, 3-й с 2000, …).
XP_PER_LEVEL = 1000
...
def grant_lesson_completion_xp_if_eligible(
    ...
    *,
    ...
    """Если теория и практика пройдены и бонус ещё не выдан — начисляет ОП, коины и помечает урок.
